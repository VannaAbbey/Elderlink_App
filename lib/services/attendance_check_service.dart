...
/// ≡ƒôï ATTENDANCE CHECK SERVICE
/// ===========================
///
/// Service to manage attendance check functionality for nurses and caregivers
///
/// **Key Features:**
/// - Γ£à Automatic attendance dialog at shift start (15-min window)
/// - ΓÅ░ Auto-mark absent after 15 minutes of no response
/// - ≡ƒæÑ Works for both nurses and caregivers
/// - ≡ƒöÆ Modal dialog (cannot dismiss until answered)
/// - ≡ƒôè Records attendance to Firestore
///
/// **Shift Times:**
...
class AttendanceCheckService {
  ...
  static Future<bool> isAtShiftStart() async {
    try {
      ...
      if (currentUser == null) {
        print('≡ƒö┤ ATTENDANCE: No user logged in');
        return false;
      }

      final now = DateTime.now();
      print('≡ƒöì ATTENDANCE: Checking shift start at ${now.toString()}');
      ...
      if (houseSnapshot.docs.isEmpty) {
        print('≡ƒö┤ ATTENDANCE: No house assignment found');
        return false;
      }
      ...
      if (startTime == null || startTime.isEmpty) {
        print('≡ƒö┤ ATTENDANCE: No start time found in assignment');
        return false;
      }
      ...
      print('≡ƒöì ATTENDANCE: Shift starts at $shiftStart');
      print(
        '≡ƒöì ATTENDANCE: Time difference: ${timeDifference.inMinutes} minutes',
      );
      print('≡ƒöì ATTENDANCE: Within window: $isWithinWindow');

      return isWithinWindow;
    } catch (e) {
      print('≡ƒö┤ ATTENDANCE Error checking shift start: $e');
      return false;
    }
  }
  ...
  static Future<bool> isScheduledToday() async {
    try {
      ...
      // ΓÜá∩╕Å TEMPORARY FOR TESTING - BYPASS SCHEDULE CHECK ΓÜá∩╕Å
      // TODO: Remove this after adding proper schedule data to Firestore!
      print('ΓÜá∩╕Å ATTENDANCE: BYPASSING SCHEDULE CHECK FOR TESTING');
      return true;
      ...
      if (houseSnapshot.docs.isEmpty) {
        print('≡ƒö┤ ATTENDANCE: No house assignment found for user ${currentUser.uid}');
        return false;
      }
      ...
      print('≡ƒôà ATTENDANCE: Today is $currentDay, assigned days: $daysAssigned');

      // Check if today is in assigned days
      return daysAssigned.contains(currentDay);
      */
    } catch (e) {
      print('≡ƒö┤ ATTENDANCE Error checking schedule: $e');
      return false;
    }
  }
  ...
  static Future<void> recordAttendance({
    ...
    try {
      final currentUser = FirebaseAuth.instance.currentUser;
      if (currentUser == null) {
        print('≡ƒö┤ ATTENDANCE: Cannot record - no user logged in');
        return;
      }
      ...
      if (!userDoc.exists) {
        print('≡ƒö┤ ATTENDANCE: User document not found');
        return;
      }
      ...
      print('Γ£à ATTENDANCE: Recorded - Present: $isPresent, Shift: $shift');
    } catch (e) {
      print('≡ƒö┤ ATTENDANCE Error recording attendance: $e');
      rethrow;
    }
  }
  ...
  static Future<bool> hasMarkedAttendanceToday() async {
    try {
      ...
      print('≡ƒöì ATTENDANCE: Already marked for today: $hasMarked');

      return hasMarked;
    } catch (e) {
      print('≡ƒö┤ ATTENDANCE Error checking attendance: $e');
      return false;
    }
  }
  ...
  static Future<void> showAttendanceDialog(
    ...
    if (_isDialogShown) {
      print('ΓÜá∩╕Å ATTENDANCE: Dialog already shown');
      return;
    }
    ...
    if (_dialogShowTime != null) {
      ...
      if (elapsed.inMinutes >= 15) {
        print(
          'ΓÅ░ ATTENDANCE: 15 minutes already elapsed - auto-marking as absent',
        );
    ...
    try {
      ...
      print('≡ƒö┤ ATTENDANCE Error showing dialog: $e');
      _isDialogShown = false;
      _cancelAutoAbsentTimer();
    }
  }
  ...
  static void _startAutoAbsentTimer(
    ...
    print('ΓÅ▒∩╕Å ATTENDANCE: Starting 15-minute auto-absent timer');

    _attendanceTimer = Timer(const Duration(minutes: 15), () async {
      print('ΓÅ░ ATTENDANCE: 15 minutes elapsed - auto-marking as absent');
      ...
      if (_isDialogShown && context.mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'ΓÜá∩╕Å You have been marked as absent for not responding within 15 minutes',
  ...
  static void _cancelAutoAbsentTimer() {
    if (_attendanceTimer != null && _attendanceTimer!.isActive) {
      ...
      print('≡ƒ¢æ ATTENDANCE: Auto-absent timer cancelled');
    }
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              isPresent
                  ? 'Γ£à Attendance marked - You are present for your shift'
                  : 'ΓÜá∩╕Å You have been marked as absent',
