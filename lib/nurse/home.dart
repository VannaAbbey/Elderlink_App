...
class _NurseHomeScreenState extends State<NurseHomeScreen> {
  ...
  final List<Widget> _screens = [
    ...
    // Replace with your real incident report screen
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: const [
              Icon(Icons.medical_services, color: Color(0xFF00588E), size: 45),
              SizedBox(width: 6),
              Text(
                "Medical Tasks",
  ...
  Widget _medicalTaskCard(
      String name, String task, String time, Color bgColor) {
    return Container(
