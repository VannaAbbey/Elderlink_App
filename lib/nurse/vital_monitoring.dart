...
/// Screen showing elderly vitals (blood pressure only)
  ...
  Future<void> _fetchElderly() async {
    try {
      ...
      for (var doc in snapshot.docs) {
        ...
        // Fetch latest vitals (blood pressure only)
        final vitalsSnap = await _firestore
            .collection('vitals')
            .where('elderly_id', isEqualTo: doc.id)
        ...
        if (vitalsSnap.docs.isNotEmpty) {
          bloodPressure = vitalsSnap.docs.first.data()['blood_pressure'] ?? '';
        }
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'Blood Pressure: ${elderly['blood_pressure'].isNotEmpty ? elderly['blood_pressure'] : 'N/A'}'),
                                  ],
                                ),
                              ),
                            );
