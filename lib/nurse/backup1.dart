...
class _IncidentReportScreenState extends State<IncidentReportScreen> {
  ...
  bool _isModalShown = false; // prevent multiple modals showing at once
  ...
  void _initNotifications() async {
    ...
    if (androidImpl != null) {
      final granted = (await androidImpl.requestPermission()) ?? false;
      print(granted
          ? "✅ Notifications permission granted!"
          : "⚠️ Notifications permission NOT granted!");
    }
  }
  ...
  void _listenEmergencyAlerts() async {
    ...
    FirebaseFirestore.instance
      ...
      // Notify & show modal for the latest alert
  ...
  Future<void> _markAlertAsViewed(String alertId) async {
    ...
    // Optional: update Firestore if you want to persist viewed status
    // await FirebaseFirestore.instance
    //     .collection('emergency_alert')
    //     .doc(alertId)
    //     .update({'viewed_by_nurse': true});
  }
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: _pickDate,
                        icon: const Icon(Icons.calendar_today, color: Color(0xFF00588E), size: 30),
                      ),
                    ],
                  ),
                  const SizedBox(height: 16),
